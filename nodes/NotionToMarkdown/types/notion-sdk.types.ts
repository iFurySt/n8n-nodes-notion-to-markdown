...
export type ParagraphBlockObjectResponse = {
  type: "paragraph"
  paragraph?: { text: Array<RichTextItemResponse>; color: ApiColor }
  parent:
    | { type: "database_id"; database_id: string }
    | { type: "page_id"; page_id: string }
    | { type: "block_id"; block_id: string }
...
export type QuoteBlockObjectResponse = {
  type: "quote"
  quote?: { text: Array<RichTextItemResponse>; color: ApiColor }
  parent:
    | { type: "database_id"; database_id: string }
    | { type: "page_id"; page_id: string }
    | { type: "block_id"; block_id: string }
...
export type ToggleBlockObjectResponse = {
  type: "toggle"
  toggle?: { text: Array<RichTextItemResponse>; color: ApiColor }
  parent:
    | { type: "database_id"; database_id: string }
    | { type: "page_id"; page_id: string }
    | { type: "block_id"; block_id: string }
